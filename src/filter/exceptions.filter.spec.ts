import { ArgumentsHost, BadRequestException, HttpException, Response, UnauthorizedException } from '@nestjs/common';
...
describe('ExceptionsFilter', () => {
  ...
  it('should handle UnauthorizedException', () => {
    const mockUnauthorizedException = new UnauthorizedException('Test UnauthorizedException');
  ...
  it('should handle BadRequestException', () => {
    const mockBadRequestException = new BadRequestException('Test BadRequestException');
