...
export class CreateInitalMigration1679051123650 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`reflash_tokens\` ADD CONSTRAINT \`FK_ed9f8a7a043227da3f679becf8a\` FOREIGN KEY (\`user_id\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`reflash_tokens\` DROP FOREIGN KEY \`FK_ed9f8a7a043227da3f679becf8a\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_ed9f8a7a043227da3f679becf8\` ON \`reflash_tokens\``
    );
    await queryRunner.query(`DROP TABLE \`reflash_tokens\``);
    await queryRunner.query(
